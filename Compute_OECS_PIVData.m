function Compute_OECS_PIVData(X,Y,U,V,smooth,q,w)
...
figure
surface(x,y,abs(Eigenvalue1))
view(30,30)

figure
surface(x,y,abs(Eigenvalue2))
view(30,30)
...
%{
for i=[1:1:smooth]
    dxev1 = filter2(h, dxev1);
    dyev1 = filter2(h, dyev1);
    dxev2 = filter2(h, dxev2);
    dyev2 = filter2(h, dyev2);
end
%
figure
surface(x,y,dxev1)
